...
namespace CaveroSalud.Api.Pages.App
{
    ...
    public class LaboratorioInventarioModel : PageModel
    {
        private readonly CaveroDbContext _db;

        public LaboratorioInventarioModel(CaveroDbContext db)
        {
            _db = db;
        }
        ...
        public async Task<IActionResult> OnPostCreateAsync()
        {
            ...
            if (existing == null)
            {
                ...
                StatusMessage = "Insumo agregado al inventario.";
            }
            else
            {
                ...
                StatusMessage = "Insumo actualizado en inventario.";
            }
